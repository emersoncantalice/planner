...
export class App {
  ...
  criarAlocacaoLo(payload: { linhaOrcamentariaId: string; nomePessoa: string; perfilId: string; horasPlanejadas: number; draft?: boolean; mesInicio?: number; valorHora?: number | null }) {
  ...
  atualizarAlocacaoLo(payload: { id: string; linhaOrcamentariaId: string; nomePessoa: string; perfilId: string; horasPlanejadas: number; draft?: boolean; mesInicio?: number; valorHora?: number | null }) {
