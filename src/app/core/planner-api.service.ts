...
export class PlannerApiService {
  ...
  createPerson(token: string, payload: { nome: string; perfilId: string; tipoVinculo: string; consultoria: string; valorHora: number | null; valorMensal: number | null; dataNascimento?: string | null; contato?: string | null }) {
    return this.http.post<any>(`${this.api}/people`, payload, { headers: this.headers(token) });
  }
  updatePerson(token: string, personId: string, payload: { nome: string; perfilId: string; tipoVinculo: string; consultoria: string; valorHora: number | null; valorMensal: number | null; dataNascimento?: string | null; contato?: string | null }) {
